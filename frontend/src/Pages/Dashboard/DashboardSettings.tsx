...
const DashboardSettings: React.FC = () => {
  ...
  return (
    <div className="flex bg-gray-50 dark:bg-slate-950 text-gray-800 dark:text-slate-100 font-sans min-h-screen">
      {/* Sidebar */}
      <aside className={`bg-white dark:bg-slate-900 border-r border-gray-200 flex flex-col z-20 shadow-sm transition-all duration-300 ease-in-out fixed lg:sticky top-[48px] md:top-[64px] h-[calc(100vh-48px)] md:h-[calc(100vh-64px)] overflow-hidden ${isSidebarOpen ? 'w-64' : 'w-0 border-none'}`}>
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col min-w-0 transition-all duration-300 ease-in-out min-h-[calc(100vh-48px)] md:min-h-[calc(100vh-64px)]">
        {/* Header */}
        <header className="sticky top-[48px] md:top-[64px] bg-white dark:bg-slate-900/95 backdrop-blur-md border-b border-gray-100 p-6 flex justify-between items-center z-40">
